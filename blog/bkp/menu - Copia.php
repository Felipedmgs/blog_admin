...
<head>
    ...
    <title>Blog | Felipe Domingues</title>
            ...
            <ul class="navbar-item flex-row ms-lg-auto ms-0">
                ...
                <li class="nav-item dropdown language-dropdown">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                        ...
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="../src/assets/img/1x1/br.svg" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Español</span></a>                        
                    </div>
                </li>
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        <a href="./app-blog-create.php" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="./app-blog-post.php" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="./app-blog-edit.php" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu active">
                        <a href="./app-blog-grid.php" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
